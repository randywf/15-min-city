          ...
          <div class="px-6 py-5 overflow-y-auto max-h-[calc(85vh-72px)]">
            ...
            <section class="space-y-3">
              ...
              <p class="text-sm leading-6 text-gray-700">
                This application demonstrates the 15-minute city concept by visualizing urban accessibility in Münster.
                Click anywhere on the map to choose a starting location. Then select a transport mode and travel time to explore which everyday amenities (such as shops, schools, or cafés) can be reached within that limit.
                The map updates interactively to help you understand how accessible different parts of the city are under various mobility scenarios.
              </p>
              ...
              <div class="grid gap-4 sm:grid-cols-2">
                <div class="rounded-xl border border-black/10 p-4">
                  ...
                  <p class="mt-1 text-sm text-gray-700 leading-6">
                    Displays the reachable area within the selected time from your starting point.
                  </p>
                  <img
                    src={poiImg}
                ...
                <div class="rounded-xl border border-black/10 p-4">
                  ...
                  <p class="mt-1 text-sm text-gray-700 leading-6">
                    Shows where amenities are concentrated, making it easy to compare different areas at a glance.
                  </p>
                  <img
                    src={heatmapImg}
                    alt="Heatmap example"
